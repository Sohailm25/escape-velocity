...
Three of six tests pass: Tests \#4, \#5, and \#6. The preregistered success criterion ($\geq 1$ pass) is \textbf{met}. We interpret this as conditional support for the bridge hypothesis under this protocol rather than mechanistic confirmation.
